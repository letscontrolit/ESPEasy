...
To support an alternative LCD Controller, using the ST7032 chip, an extra selection has been added. This controller uses the (fixed) I2C address ``0x3E``, so that has to be configured as well.
