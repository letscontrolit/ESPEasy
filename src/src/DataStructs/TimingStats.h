...
# define HANDLE_ESPEASY_NOW_LOOP   63
# define EXPIRED_ESPEASY_NOW_LOOP  64
# define INVALID_ESPEASY_NOW_LOOP  65
# define RECEIVE_ESPEASY_NOW_LOOP  66
# define ESPEASY_NOW_SEND_MSG_SUC  67
