...
//        if (!msgAir026) // Mysensors
//          msgAir026 = new MyMessage(event->BaseVarIndex, V_LEVEL); //Mysensors
//        present(event->BaseVarIndex, S_AIR_QUALITY); //Mysensors
//        Serial.print("Present ADS1115 MQ135: "); //Mysensors
...
//        send(msgAir026->set(UserVar[event->BaseVarIndex], 1)); // Mysensors
