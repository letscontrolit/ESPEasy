...
#if ! defined(OMIT_GOOGLE_COM_CERT)
...
static const unsigned char PROGMEM GOOGLE_DN[] = {
...
static const unsigned char PROGMEM  GOOGLE_RSA_N[] = {
...
static const unsigned char PROGMEM  GOOGLE_RSA_E[] = {
    0x01, 0x00, 0x01,
};
...
#if ! defined(OMIT_GOOGLE_COM_CERT)
	{
		{ (unsigned char *)GOOGLE_DN, sizeof GOOGLE_DN },
		BR_X509_TA_CA,
		{
			BR_KEYTYPE_RSA,
			{ .rsa = {
				(unsigned char *)GOOGLE_RSA_N, sizeof GOOGLE_RSA_N,
				(unsigned char *)GOOGLE_RSA_E, sizeof GOOGLE_RSA_E,
			} }
		}
	}
#if ! defined(OMIT_LETS_ENCRYPT_CERT) || defined(INCLUDE_LOCAL_CERT)
    ,
#endif
#endif
