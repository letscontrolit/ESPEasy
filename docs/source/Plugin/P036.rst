...
Status ESP32: |P036_status|

Status ESP8266: |P036_status_lb|
...
* **Hide startup logo**: When checked, the ESPEasy logo, normally shown for a few moments as the plugin is starting, will *not* appear, but the regular data will just be displayed.
