...
IRTEXT_CONST_BLOB_DECL(kAllProtocolNamesStr) {
    ...
    #if DECODE_GORENJE || SEND_GORENJE
    D_STR_GORENJE "\x0"
    #else
    D_STR_UNSUPPORTED "\x0"
    #endif  // if DECODE_GORENJE || SEND_GORENJE
    #if DECODE_WOWWEE || SEND_WOWWEE
    D_STR_WOWWEE "\x0"
    #else
    D_STR_UNSUPPORTED "\x0"
    #endif  // if DECODE_WOWWEE || SEND_WOWWEE
    #if DECODE_CARRIER_AC84 || SEND_CARRIER_AC84
    D_STR_CARRIER_AC84 "\x0"
    #else
    D_STR_UNSUPPORTED "\x0"
    #endif  // if DECODE_CARRIER_AC84 || SEND_CARRIER_AC84
    #if DECODE_YORK || SEND_YORK
    D_STR_YORK "\x0"
    #else
    D_STR_UNSUPPORTED "\x0"
    #endif  // if DECODE_YORK || SEND_YORK
