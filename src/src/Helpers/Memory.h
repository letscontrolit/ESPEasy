...
void* special_realloc(void  *ptr,
                      size_t size);
void* special_calloc(size_t num,
                     size_t size);
void* special_calloc(size_t num,
                     size_t size,
                     bool   preferHeap);
...
// when possible.
bool String_reserve_special(String& str,
                            size_t  size);
bool String_reserve_special(String& str,
                            size_t  size,
                            size_t  strLengthThreshold);
