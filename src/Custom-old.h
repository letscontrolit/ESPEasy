...
#define DEFAULT_AP_IP       192, 168, 1, 250                           // Enter IP address (comma separated) for AP (config) mode
...
#define DEFAULT_NTP_HOST                        "192.168.1.10"                // NTP Server Hostname
#define DEFAULT_TIME_ZONE                       60                 // Time Offset (in minutes)
#define DEFAULT_USE_DST                         true             // (true|false) Use Daily Time Saving

#define DEFAULT_LATITUDE                        51.173125f              // Default Latitude  
#define DEFAULT_LONGITUDE                       17.202763f              // Default Longitude
