...
#.  **Choose the type of sensor you want to use**
    ...
    With the drop down field you can chose the sensor type you wnat to use.

    .. image:: P039_press_submit.png
      :width: 200
      :alt: image showing the configuration section to submit the configuration so far

    After this selection please submit the configuration done so far to allow adjustment of the following sections to the chosen sensor type.
...
#.  **Choose the type of the adapter device you use**
    ...
    After this selection please submit the configuration done so far to allow adjustment of the following sections to the chosen device type.
...
TODO: detail the configuration options for MAX 31856 device
