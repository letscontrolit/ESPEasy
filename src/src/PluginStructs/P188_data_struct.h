...
const __FlashStringHelper* Plugin_188_output_mapping_name(uint8_t value_nr,
                                                          bool    displayString);
...
public:
  ...
  static uint8_t TLA2528_read_single_reg(uint8_t i2caddr,
                                         uint8_t reg);
  static bool    TLA2528_write_single_reg(uint8_t i2caddr,
                                          uint8_t reg,
                                          uint8_t data);
