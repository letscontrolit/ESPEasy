...
Additional writing of such a record can also be triggered through the ``LogPulseStatistic`` command (see above).
...
+----------------------------------------------------------------+
| [2046017|2045826|2045826/1|2045821/0/5|2045810] [11979|104201] |
+----------------------------------------------------------------+
