...
The SDC41 also supports single-shot measurements, to enable really low averasge power consumption as it will enter a power-saving state when not measuring.
