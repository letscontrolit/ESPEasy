...
* **Error State Value** If no sensor is connected, or the sensor suffers from read errors for some reason, the value to report in that situation can be set here.
