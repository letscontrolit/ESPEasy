...
Warning: Only one Motor Shield can be used on a ESPEasy device. This is a limitation of the ESPEasy plugin.
...
But in Oct-2020 the ESPEasy plugin was updated to support the Lolin 2.0 Motor Shield.
