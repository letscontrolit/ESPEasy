...
bool ExecuteCommand_all_config_eventOnly(EventValueSource::Enum source,
                                         const char            *Line);

bool ExecuteCommand_internal(EventValueSource::Enum source,
                             const char            *Line);

bool ExecuteCommand_plugin(EventValueSource::Enum source,
                           const char            *Line);

bool ExecuteCommand_plugin(taskIndex_t            taskIndex,
