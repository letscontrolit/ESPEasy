...
#define BUILD_GIT           "Brick4U: "  __DATE__ " "  __TIME__


#define DEFAULT_NAME        "bw-2005001"                             // Enter your device friendly name
...
#define DEFAULT_AP_KEY      "verBrickt2020!"                         // Enter network WPA key for AP (config) mode

// --- Wifi Client Mode -----------------------------------------------------------------------------
#define DEFAULT_SSID                         "MikroTik2"          // Enter your network SSID
#define DEFAULT_KEY                          "Wednesday28"            // Enter your network WPA key
...
//#define DEFAULT_ADMIN_PASS                   "verBrickt2020!"
...
//#define DEFAULT_CONTROLLER_USER    "b4upub"                                 // Default controller user
//#define DEFAULT_CONTROLLER_PASS    "b4u40819dt"                             // Default controller Password
...
//#define DEFAULT_SERVER_HOST "broker00.brick4u.de"                                              // Server hostname
