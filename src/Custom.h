...
// --- Wifi Client Mode -----------------------------------------------------------------------------
#define DEFAULT_SSID                         "WiFi_IoT"            // Enter your network SSID
#define DEFAULT_KEY                          "Oggy_1234" // Enter your network WPA key
...
#define DEFAULT_PUB         "/home/%sysname%/%tskname%/%valname%" // Enter your pub
#define DEFAULT_SUB         "/cmd/%sysname%/#"                   // Enter your sub
#define DEFAULT_SERVER      "192.168.0.8"                                   // Enter your Server IP address
#define DEFAULT_SERVER_HOST "mqtt.lan"                                              // Server hostname
...
#define DEFAULT_NTP_HOST                        "192.168.8.1"                // NTP Server Hostname
...
#define DEFAULT_SYNC_UDP_PORT                   1111              // Used for ESPEasy p2p. (IANA registered port: 8266)
