...
/**
 * Changelog:
 * 2022-02-19 pkretz: Adapted fpot TTGO Display
...
This plugin allow to control a TFT screen (TFT_eSPI) through HTTP API

## Environment
Tested with TTGO Display

TFT_eSPI Library: https://github.com/Xinyuan-LilyGO/TTGO-T-Display
TFT Shield : http://www.lilygo.cn/prod_view.aspx?Id=1126
Price : ~ 14€ (https://de.aliexpress.com/item/33048962331.html)


## Dependencies
Plugin lib_deps = TFT_eSPI


## SPI Setting in Hardware Section
...
## Settings in Plugin Configuration:
CS: GPIO 5
DC: GPIO 16
RST: GPIO 23
Rotation: as you want it
    ...
    case PLUGIN_WEBFORM_LOAD:
      {
        ...
        if(init == 1)
        {
          TFT_eSPI_Settings.address_tft_cs = PIN(0);
          TFT_eSPI_Settings.address_tft_dc = PIN(1);
          TFT_eSPI_Settings.address_tft_rst = PIN(2);
        }
