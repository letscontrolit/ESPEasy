...
Only one Motor Shield can be used on a ESPEasy device. This is a limitation of the ESPEasy plugin.
...
The original firmware has reliability issues, such as hard lockup (hang) of the I2C bus.
