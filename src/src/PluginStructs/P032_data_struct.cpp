...
void P032_data_struct::readout() {
  ...
  OFF                -= OFF2;
  SENS               -= SENS2;
  ms5611_pressure     = (((D1 * SENS) / (1 << 21) - OFF) / (1 << 15)); // FIXME TD-er: This is computed twice, is that correct?
}
