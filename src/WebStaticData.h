                        ...
                        "for (k = 0; k < data.Sensors[c].TaskValues.length; k++) {"
                            ...
                            "} finally {"
                                "if (valueEntry !== 'TypeError') {"
                                    ...
                                    "if (valueElement !== null) { document.getElementById(valueID).innerHTML = tempValue; }"
                                    "if (valueNameElement !== null) { document.getElementById(valueNameID).innerHTML = data.Sensors[c].TaskValues[k].Name + ':'; }"
                                "}"
                            "}"
                        "}"
                      "}"
