...
bool do_command_case(command_case_data& data,  command_function_fs pFunc, int nrArguments, EventValueSourceGroup::Enum group);
bool do_command_case(command_case_data& data,  command_function pFunc, int nrArguments, EventValueSourceGroup::Enum group);
