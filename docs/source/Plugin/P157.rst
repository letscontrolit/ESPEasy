...
* **Right align Temperature (7dt)**: By default the temperature display on 8 digit or wider displays, is shown right aligned on position 1..7. This option enabled right-aligns the temperature to position 8.
