...
# define HANDLE_ESPEASY_NOW_LOOP   62
# define EXPIRED_ESPEASY_NOW_LOOP  63
# define INVALID_ESPEASY_NOW_LOOP  64
# define RECEIVE_ESPEASY_NOW_LOOP  65
# define ESPEASY_NOW_SEND_MSG_SUC  66
# define ESPEASY_NOW_SEND_MSG_FAIL 67
# define ESPEASY_NOW_SEND_PCKT     68
# define ESPEASY_NOW_DEDUP_LOOP    69
