...
# define P183_NR_OUTPUTS       PCONFIG(P183_NR_OUTPUTS_INDEX)
# define P183_NR_OUTPUTS_LABEL PCONFIG_LABEL(P183_NR_OUTPUTS_INDEX)
# define P183_ADDRESS(x) PCONFIG(P183_NR_OUTPUTS_INDEX + 1 + x)
