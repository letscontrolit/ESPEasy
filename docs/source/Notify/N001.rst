...
Along with the pre-defined settings, it is possible to customized the email's recipient(s), subject line, and message body, all from the Notify command rule.
