...
# define HANDLE_ESPEASY_NOW_LOOP 56
# define EXPIRED_ESPEASY_NOW_LOOP 57
# define INVALID_ESPEASY_NOW_LOOP 58
# define RECEIVE_ESPEASY_NOW_LOOP 59
# define ESPEASY_NOW_SEND_MSG_SUC 60
# define ESPEASY_NOW_SEND_MSG_FAIL 61
# define ESPEASY_NOW_SEND_PCKT    62
# define ESPEASY_NOW_DEDUP_LOOP   63
