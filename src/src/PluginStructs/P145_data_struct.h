...
public:
  ...
  void  setSensorData(int   stype,
                      ...
                      float zero,
                      float ref);
  void                setSensorPins(int analogPin,
                                    int heaterPin);
...
private:
  ...
  float getTempHumCorrection(float temperature,
                             float humidity) const;
  float getCorrectedRZero(float rSensor,
                          float temperature,
                          float humidity) const;
  float getPPM(float rSensor);
  float getCorrectedPPM(float rSensor,
                        float temperature,
                        float humidity);
