...
Status ESP32: |P078_status|

Status ESP8266: |P078_status_lb|
...
A flow  control GPIO pin can be configured on the web UI to control ``RE/DE`` while sending data if needed. 
