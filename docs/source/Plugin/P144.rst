...
Note: The current plugin does not support direct communication with the PM1006(K) sensor. However, the plugin can be extended alter to also support standalone control of this device.
...
**Serial Port** : Select the serial port to be used. Choices depend on the type of ESP chip being used. See serial port in this manual for the available options.
