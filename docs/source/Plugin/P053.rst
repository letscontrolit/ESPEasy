...
All supported Plantower modules can measure the concentration of dust particles, binned per size of the particle.
...
It is likely that the modules capable of measuring the humidity can also compensate for the humidity when calculating the concentration in µg/m3.
However, so far it is unclear whether those sensors actually do compensate for this.
...
To compare these, use as conversion factor:  1 ppm = 1.25 mg/m3
...
Short-term peaks,  e.g.  in heavy  traffic or during  severe inversions, can  range  up  to  100  µg/m3. 
...
At concentrations above 0.1 ppm (125 µg/m3) in air formaldehyde can irritate the eyes and mucous membranes.
