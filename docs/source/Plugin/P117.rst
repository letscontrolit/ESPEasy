...
* **Automatic Calibration (ABC)**: When enabled, the automatic calibration will be activated when the plugin is started.
...
.. versionchanged:: 2.0
  ...
  |added|
  2022-02-26 Added commands and setting for automatic calibration and forced recalibration.
