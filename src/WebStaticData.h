        ...
        "} else {"
            ...
            "var logEntry;"
                    ...
                    "if (logEntriesChunk == null) {"
                      "logEntriesChunk = '';"
                    "}"
                    "logEntriesChunk += '<div class=level_' + data.Log.Entries[c].level + ' id=' + data.Log.Entries[c].timestamp + '><font color=\"gray\">' + data.Log.Entries[c].timestamp + ':</font> ' + data.Log.Entries[c].text + '</div>';"
    							"}"
    						"}"
    				"}"
