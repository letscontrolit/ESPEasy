...
//  Input signal is read from another task (plugin) by accessing TASK & VALUE
...
# define P021_INV_OUTPUT            1 // Invert output signal
# define P021_GUID_INV_OUTPUT       "b1"
# define P021_EXT_FUNCT             2 // Extended functionality on setup screen
# define P021_GUID_EXT_FUNCT        "b2"
# define P021_INV_INPUT             3 // Invert input comparator
# define P021_GUID_INV_INPUT        "b3"
# define P021_SYM_HYSTERESIS        4 // Use symetrical hysteresis
# define P021_GUID_SYM_HYSTERESIS   "b4"
# define P021_SLOW_EVAL             5 // 1Hz evaluation i.s.o. 10Hz
# define P021_GUID_SLOW_EVAL        "b5"
# define P021_STATE_OUTP            6 // Add state as additional output value
# define P021_GUID_STATE_OUTP       "b6"
# define P021_EXTEND_END            7 // Extend state timed from start
# define P021_GUID_EXTEND_END       "b7"
...
#define P021_VALUE_OUTPUT           0
#define P021_VALUE_STATE            1
#define P021_VALUE_AUTOSAVE_FLAG    2
#define P021_VALUE_AUTOSAVE_TIME    3
    ...
    case PLUGIN_SET_CONFIG:
    {
      ...
      if (isSetLevel || isHysteresis || isRemote) {
        ...
        if (!isError(Calculate(value, result))) {
          ...
          String log = F("Invalid config parameter for task: ");
          log += event->TaskIndex;
          log += F(" command: ");
          log += command;
          log += F(" value: ");
...
void P021_evaluate(struct EventStruct *event)
{
  ...
  switch ((P021_opmode)(P021_OPMODE))
  {
    ...
    case P021_OPMODE_STANDBY:
      ...
      if (old_control_state == P021_STATE_IDLE) // Pump was idling
      {
