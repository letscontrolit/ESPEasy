...
boolean Plugin_103(uint8_t function, struct EventStruct *event, String &string)
{
  ...
  case PLUGIN_GET_DEVICEVALUENAMES:
  {
    ...
    {
      const int i2cAddressValues[] = {0x61, 0x62, 0x63, 0x64}; // , 0x65, 0x66, 0x67}; // Disabled unsupported devices as discussed here: https://github.com/letscontrolit/ESPEasy/pull/3733 (review comment by TD-er)
