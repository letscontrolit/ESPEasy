...
#define CLK_HIGH(void) digitalWrite(clk_pin, HIGH)
#define CLK_LOW(void) digitalWrite(clk_pin, LOW)
#define DIO_HIGH(void) pinMode(dio_pin, INPUT)
#define DIO_LOW(void) pinMode(dio_pin, OUTPUT)
