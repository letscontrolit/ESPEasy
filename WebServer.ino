...
#define HTML_SYMBOL_WARNING "&#9888;"
 ...
 #define POST_METHOD "method='post'"
#else
 #define POST_METHOD "method='post' enctype='multipart/form-data'"
#endif
...
void handle_config() {
  ...
  reply += F("<form name='frmselect' "POST_METHOD"><table>");
...
void handle_controllers() {
  ...
  reply += F("<form name='frmselect' "POST_METHOD">");
...
void handle_hardware() {
  ...
  reply += F("<form  "POST_METHOD"><table><TR><TH>Hardware Settings<TH><TR><TD>");
...
void handle_advanced() {
  ...
  reply += F("<form  "POST_METHOD"><table>");
